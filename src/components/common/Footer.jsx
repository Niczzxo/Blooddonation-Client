...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-[#0a0a0a] pt-24 pb-12 overflow-hidden border-t border-gray-100 dark:border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white font-black">hello@bloodsync.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-red-400 rounded-[2.5rem] blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
        ...
        <div className="pt-12 border-t border-gray-50 dark:border-gray-800 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-gray-500 dark:text-gray-400 font-medium text-sm">
            © {currentYear} <span className="text-red-500 font-black tracking-tighter">BloodSync</span>. All rights reserved.
          </p>
