                ...
                <div className={`flex items-center justify-between py-2 px-4 md:px-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-full shadow-lg border border-red-100 dark:border-gray-800 transition-all ${scrolled ? "shadow-xl" : ""}`}>
                    ...
                    <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
                        ...
                        <Link to="/" onClick={closeMenu} className="flex items-center gap-3 group">
                            ...
                            <h1 className="text-2xl font-black text-gray-900 dark:text-white tracking-tighter hidden sm:block">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        {user ? (
                            ...
                            <Link
                                to="/login"
                                className="hidden xs:flex btn btn-sm md:btn-md bg-red-600 hover:bg-red-700 text-white border-none rounded-full px-4 md:px-8 font-bold shadow-lg shadow-red-200 dark:shadow-none"
                            >
                                Login
                            </Link>
                        )}
                        ...
                        >
                            <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-red-50 dark:border-gray-800 p-4">
                                <ul className="flex flex-col gap-2">
                                    ...
                                    {!user && (
                                        <li className="mt-2 block xs:hidden" onClick={closeMenu}>
