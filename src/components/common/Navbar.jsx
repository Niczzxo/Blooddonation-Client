            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    <div className="flex items-center justify-end flex-1 lg:flex-none gap-1 md:gap-4">
                        ...
                        {user ? (
                            <div className="dropdown dropdown-end">
                                <label
                                    tabIndex={0}
                                    className="flex items-center gap-2 cursor-pointer hover:bg-rose-50 dark:hover:bg-gray-800 rounded-full p-1 transition-all"
                                >
                                    <div className="avatar">
                                        <div className="w-8 h-8 md:w-10 md:h-10 rounded-full ring-2 ring-rose-500 ring-offset-2 ring-offset-white dark:ring-offset-gray-900">
                                            <img
                                    ...
                                    <div className="hidden sm:flex flex-col text-left pr-2">
                                        ...
                                        <span className="text-[10px] uppercase tracking-wider text-rose-600 font-bold leading-none">
                                            {role}
                                        </span>
                                    </div>
                                </label>
                                ...
                                >
                                    ...
                                    <li>
                                        <Link to="/dashboard" className="flex items-center gap-3 py-3 px-4 hover:bg-rose-50 dark:hover:bg-rose-900/10 text-gray-700 dark:text-gray-300 rounded-xl">
                                            <LayoutDashboard size={18} className="text-rose-500" />
                                            Dashboard
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/profile" className="flex items-center gap-3 py-3 px-4 hover:bg-rose-50 dark:hover:bg-rose-900/10 text-gray-700 dark:text-gray-300 rounded-xl">
                                    ...
                                    <li>
                                        <button
                                            ...
                                            className="flex items-center gap-3 py-3 px-4 text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/10 rounded-xl font-bold"
                                        >
                                            <LogOut size={18} />
                                            Logout
                                        </button>
                            ...
                            <div className="hidden lg:block">
                                <Link
                                    to="/login"
                                    className="btn btn-sm md:btn-md bg-rose-600 hover:bg-rose-700 text-white border-none rounded-full px-4 md:px-8 font-bold shadow-lg shadow-rose-200 dark:shadow-none transition-all"
                                >
                                    Login
                                </Link>
                            </div>
                ...
                <AnimatePresence>
                    {menuOpen && (
                        ...
                        >
                            <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-rose-50 dark:border-gray-800 p-4">
                                <ul className="flex flex-col gap-2">
                                    ...
                                    {!user && (
                                        <li className="mt-2 block" onClick={closeMenu}>
                                            <Link to="/login" className="btn btn-block bg-rose-600 text-white rounded-2xl">Login</Link>
                                        </li>
                                    )}
                                </ul>
                            </div>
