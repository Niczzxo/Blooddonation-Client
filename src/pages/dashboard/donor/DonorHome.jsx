    ...
    return (
        <div className="p-4 md:p-10 space-y-10 max-w-6xl mx-auto">
            ...
            <Motion.div 
                ...
                className="relative overflow-hidden bg-white dark:bg-gray-800 rounded-[3rem] p-8 md:p-12 border border-gray-100 dark:border-gray-700 shadow-2xl shadow-red-100 dark:shadow-none"
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-10 flex flex-wrap gap-4">
                        ...
                        <Link 
                            ...
                            className="btn h-auto py-4 px-8 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-900 dark:text-white border-none rounded-2xl font-black text-lg flex items-center gap-3 transition-transform hover:scale-105 active:scale-95"
                        >
                            <Activity size={20} />
                            View Stats
                        </Link>
            ...
            {recentRequests.length > 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {recentRequests.map((req, idx) => (
                            <Motion.div 
                                ...
                                className="bg-white dark:bg-gray-800 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 p-8 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2 group"
                            >
                                ...
                                <Link 
                                    ...
                                    className="w-full btn h-auto py-3 bg-gray-50 dark:bg-gray-900 group-hover:bg-red-600 text-gray-600 dark:text-white group-hover:text-white border-none rounded-xl font-black transition-all flex items-center justify-center gap-2"
                                >
                                    Details
                                    <ArrowRight size={16} />
                                </Link>
                ...
                <Motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.2 }}
                    className="text-center py-24 bg-white dark:bg-gray-800 rounded-[3rem] border border-dashed border-gray-200 dark:border-gray-700"
                >
