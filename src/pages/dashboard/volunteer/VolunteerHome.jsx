        ...
        <div className="min-h-screen mt-10 p-6 md:p-10">
            ...
            <div className="text-center mb-10">
                <h1 className="text-3xl md:text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tighter uppercase">
                    Welcome Back <br /> <span className="text-rose-600">{user.displayName}</span>
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                ...
                <div className="bg-rose-50/50 dark:bg-gray-900 rounded-3xl shadow-2xl border border-rose-100 dark:border-gray-800 overflow-hidden transform hover:scale-105 transition-all duration-300 group">
                    ...
                    <div className="bg-rose-50 dark:bg-gray-800 px-6 py-4 border-t border-rose-100 dark:border-gray-700">
            ...
            <div className="text-center mt-20">
                <p className="text-2xl md:text-4xl font-black text-gray-700 dark:text-gray-300 uppercase tracking-tighter">
                    Every number here represents a <span className="text-rose-600">saved life</span>
                </p>
            </div>
        </div>
    );
