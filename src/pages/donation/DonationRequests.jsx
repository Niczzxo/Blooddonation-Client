        ...
        <div className="max-w-7xl mx-auto py-20 px-4 min-h-screen">
            ...
            {loading ? (
                ...
                <Motion.div 
                    ...
                    className="text-center py-20 bg-white dark:bg-gray-800 rounded-[3rem] p-12 border border-dashed border-gray-200 dark:border-gray-700 shadow-xl"
                >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {requests.map((req, idx) => (
                        <Motion.div 
                            ...
                            className="group bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-1"
                        >
                            ...
                            <div className="p-8">
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                                      <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded-lg"><MapPin size={18} /></div>
                                      <span className="font-medium">{req.recipient_district}, {req.recipient_upazila}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                                      <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded-lg"><Hospital size={18} /></div>
                                      <span className="font-medium truncate">{req.hospital_name || "Private Location"}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                                      <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded-lg"><Calendar size={18} /></div>
