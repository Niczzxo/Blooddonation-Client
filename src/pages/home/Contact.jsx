    ...
    <section className="w-11/12 mx-auto my-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-rose-50/50 dark:bg-gray-900 rounded-[2.5rem] shadow-2xl p-8 md:p-12 border border-rose-100 dark:border-gray-800">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  rows="5"
                  required
                  className="textarea textarea-bordered w-full bg-rose-50/20 dark:bg-gray-950 border-rose-100 dark:border-gray-800 rounded-2xl focus:ring-2 focus:ring-rose-600 transition-all font-bold mt-2 p-4"
