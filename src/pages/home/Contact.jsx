          ...
          <div className=" bg-gradient-to-br from-red-100 to-red-300 rounded-3xl shadow-2xl p-8 border border-red-100 dark:border-red-900">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  type="email"
                  className="input input-bordered w-full rounded-xl border-red-200 focus:border-red-500"
              ...
              <div>
                ...
                <textarea
                  rows="5"
                  required
                  className="textarea textarea-bordered w-full rounded-xl border-red-200 focus:border-red-500"
          ...
          <div className="space-y-10">
            <div className="rounded-3xl shadow-2xl p-10 text-center border bg-gradient-to-br from-red-200 to-red-500">
              ...
              <div className="space-y-4">
                <a className="btn btn-lg rounded-full bg-white text-red-500 hover:bg-red-50 border-none shadow-xl px-10 text- font-bold hover:scale-105 transition-all">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-red-200 to-red-500 border rounded-2xl p-6 text-center shadow-xl">
