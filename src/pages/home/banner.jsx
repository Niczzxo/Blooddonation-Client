...
const Banner = () => {
  return (
    ...
    bg-gradient-to-br from-red-50 to-red-100 dark:from-gray-900 dark:to-gray-800 border border-red-100 dark:border-gray-800">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <Motion.div 
          ...
          className="absolute top-10 left-10 text-red-500 text-9xl blur-sm"
        >🩸</Motion.div>
        <Motion.div 
          animate={{ scale: [1, 1.1, 1], rotate: [0, -10, 0] }}
          transition={{ duration: 7, repeat: Infinity }}
          className="absolute bottom-20 right-20 text-red-500 text-8xl blur-sm"
        >🩸</Motion.div>
        <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-red-400/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-red-500/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6 md:px-16">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-100 dark:bg-red-900/30 text-red-500 dark:text-red-400 rounded-full text-sm font-bold tracking-widest uppercase mb-8">
            <HeartPulse size={16} />
            Every Drop Counts
          </div>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-gray-900 dark:text-white mb-8 leading-[0.9] tracking-tighter">
            DONATE <span className="text-red-500">BLOOD</span>
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
            <Motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/register"
                className="btn h-auto px-10 py-5 rounded-2xl bg-red-600 hover:bg-red-700 text-white border-none shadow-xl shadow-red-200 dark:shadow-none text-xl font-bold transition-all flex items-center gap-3"
              >
        ...
        >
          <div className="absolute inset-0 bg-red-500/20 rounded-full blur-3xl group-hover:bg-red-500/30 transition-colors"></div>
          <img 
            src={slide1} 
