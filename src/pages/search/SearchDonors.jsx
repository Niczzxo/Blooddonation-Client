        ...
        <div className="max-w-7xl mx-auto py-20 px-4 min-h-screen">
            <div className="max-w-5xl mx-auto">
                ...
                <Motion.div 
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl shadow-red-100 dark:shadow-none border border-gray-100 dark:border-gray-700 p-8 md:p-12 mb-20"
                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="select select-bordered w-full h-14 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-red-600 transition-all font-bold"
                                >
                            ...
                            {donors.map((donor, idx) => (
                                ...
                                >
                                    ...
                                    <div className="relative mb-6">
                                        <div className="w-32 h-32 mx-auto rounded-full p-1 bg-gradient-to-br from-red-600 to-rose-400">
                                            <img
